document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Google Translate Proxy Logic (Fast Batch Processing)
    async function translateText(text, targetLang) {
        ...
        // Process in batches of 5 requests simultaneously to boost speed by 500%
        const batchSize = 5;
        ...
        for (let i = 0; i < chunks.length; i += batchSize) {
            ...
            // Wait for this specific batch to finish before moving to next
    ...
    extractBtn.addEventListener('click', async () => {
        ...
        transcriptOutput.innerHTML = `<span style="color: #a78bfa;">Fetching and Translating... High-speed AI is working.</span>`;

        try {
            // Deduct 1 Credit instantly
            currentCredits -= 1; 
